...
def main():  # noqa: C901
    ...
    feedback_rect = pygame.Rect(
        ...
        window_width,
        30,
    )  # Define the area for feedback text
    ...
    neutral_sprite = pygame.transform.scale(
        neutral_sprite,
        (600, 600),
    )  # Resizing sprites
    ...
    input_box = pygame.Rect(
        ...
        200,
        50,
    )  # Resizing input box to be the same size as submit button
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                speech_bubble_rect.center = (
                    current_sprite_rect.right + 100,
                    current_sprite_rect.top + 50,
                )
                main_menu_button_rect.x = window_width - 220
        ...
        if current_screen == "menu":
            ...
            for achievement in achievements:
                ...
                padlock_sprite = pygame.transform.scale(
                    padlock_sprite,
                    (30, 30),
                )  # Resize padlock sprite
                ...
                if achievement["reward"] in COLORS:
                    ...
                    reward_sprite = pygame.transform.scale(
                        reward_sprite,
                        (60, 60),
                    )  # Resize galaxy sprite
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.button == 4:  # Scroll up
                        ...
                        scroll_offset = max(
                            scroll_offset - 20,
                            window_height - achievements_surface.get_height(),
                        )
                    ...
                    for rect, achievement_name, reward in equip_button_rects:
                        if rect.collidepoint(event.pos):
                            print(
                                f"Clicked on {achievement_name}, reward: {reward}",
                            )  # Debug print statement
                            ...
                            if player_data["achievements"].get(achievement_name, False):
                                if reward in [
                                    ...
                                    if player_data["equipped"].get("background") == reward:
                                        print(
                                            f"Unequipping background: {reward}",
                                        )  # Debug print statement
                                        del player_data["equipped"]["background"]  # Unequip the background
                                    else:
                                        print(
                                            f"Equipping background: {reward}",
                                        )  # Debug print statement
                                    ...
                                    if player_data["equipped"].get("sprite") == reward:
                                        print(
                                            f"Unequipping sprite: {reward}",
                                        )  # Debug print statement
                                        del player_data["equipped"]["sprite"]  # Unequip the sprite
                                    else:
                                        print(
                                            f"Equipping sprite: {reward}",
                                        )  # Debug print statement
            ...
            if previous_screen != "settings":
                ...
                screen.blit(
                    settings_title,
                    (window_width // 2 - settings_title.get_width() // 2, 10),
                )
            ...
            if show_confirmation_popup:
                ...
                confirm_button_rect = pygame.Rect(
                    confirmation_rect.left + 40,
                    confirmation_rect.bottom - 70,
                    100,
                    50,
                )
                cancel_button_rect = pygame.Rect(
                    confirmation_rect.right - 140,
                    confirmation_rect.bottom - 70,
                    100,
                    50,
                )
                ...
                screen.blit(
                    confirm_text,
                    confirm_text.get_rect(center=confirm_button_rect.center),
                )
                screen.blit(
                    cancel_text,
                    cancel_text.get_rect(center=cancel_button_rect.center),
                )
