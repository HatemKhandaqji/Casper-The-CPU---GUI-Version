...
def transition_to_gameplay(player_data, screen, window_width, window_height):
...
def main():
    ...
    player_data["statistics"] = player_data.get("statistics", {})  # Ensure statistics key is present
            ...
            if event.type == pygame.QUIT:
                ...
                if current_screen == "menu":
                    if start_button_rect.collidepoint(event.pos):
                        ...
                        transition_to_gameplay(player_data, screen, window_width, window_height)
                        ...
                        if start_button_rect.collidepoint(event.pos):
                            ...
                            if "background" in player_data["equipped"]:
                                ...
                                if background in COLORS:
                                    ...
                                    print(f"Background set to {background}")  # Debug print statement
                            ...
                            score_surface = button_font.render("Score: " + str(statistics.score), True, black)
                            screen.blit(score_surface, (10, 10))

                            high_score_surface = button_font.render("High Score: " + str(statistics.high_score), True, black)
                ...
                if current_screen == "gameplay":
                        ...
                        if submit_button_rect.collidepoint(event.pos):
                            try:
                                ...
                                if guess == casper_number:
                                    ...
                                    feedback_text = "Incorrect, you didn't guess the number Casper was thinking of. Try again!"
                        ...
                        if current_sprite_rect.collidepoint(event.pos):
                            ...
                            check_achievements(achievements, player_data, statistics)  # Check achievements after updating sprite taps

                        if main_menu_button_rect.collidepoint(event.pos):
                            current_screen = "menu"
                            transition_to_menu(screen)
                            save_player_data(player_data, statistics, achievements)  # Save player data when returning to the menu
                    ...
                    for rect, achievement_name, reward in equip_button_rects:
                        if rect.collidepoint(event.pos):
                            ...
                            if player_data["achievements"].get(achievement_name, False):
                                ...
                                save_player_data(player_data, statistics, achievements)  # Save the updated equipped state
                                break
